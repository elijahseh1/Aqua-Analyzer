...
if st.button("Generate Visualization"):
    ...
    ph_scale_img = Image.open(image_path)
    draw = ImageDraw.Draw(ph_scale_img)
    
    img_width, img_height = ph_scale_img.size
    ...
    st.image(ph_scale_img, caption=f"Marker showing selected pH value: {user_ph}")
